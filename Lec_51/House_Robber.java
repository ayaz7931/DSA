...
public class House_Robber {
	...
	public static void main(String[] args) {
		...
		System.out.println(Robber1(arr, arr.length-1));
	...
	public static int RobberTD(int[] arr, int i,int[] dp) {   //Top-Down Approach
		if(i<0) {
			return 0;
		}
		if(dp[i]!= -1) {
	...
	public static int RobberBU(int[] arr) {   //Bottom-Up Approach
		if(arr.length==1)
		{
			return arr[0];
		}
